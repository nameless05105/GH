...
class EditTechnology extends React.Component{
    /** 
...
const mapDispatchToProps = dispatch => ({
    editTechnology: data => {
        dispatch(sendData(data,'EDIT_TECHNOLOGY'))
...
export default connect(mapStateToProps,mapDispatchToProps)(EditTechnology);