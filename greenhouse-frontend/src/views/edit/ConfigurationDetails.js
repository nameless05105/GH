...
class ConfigurationDetails extends React.Component{
  ...
  async componentDidMount(){
    const containers = await api.getAllContainers(this.props.greenhouse.id);
    const configuration = await api.getConfigurationById(this.props.id);
    const container = containers.data.data.find(container => container._id === configuration.data.data.containerId);
    const technology = await api.getTechnologyByContainerId(configuration.data.data.containerId);
      this.setState(
        {
          containers: containers.data.data,
          modules: configuration.data.data.modules,
          name: configuration.data.data.name,
          container: container,
      ...
      >  
        ...
        >
          <TextField
            ...
            value={this.state.modules[i].indicator}
            variant="outlined"
          >
              <option value=''></option>
        ...
        >
          <TextField
            ...
            value={this.state.modules[i].sign}
            variant="outlined"
          >
              <option value=''></option>
              <option value={'>'}>&lt;</option>
        ...
        >
          <TextField
            ...
            value={this.state.modules[i].value}
            variant="outlined"
          >
          </TextField>
        </Grid>
        ...
        >
          <TextField
            ...
            value={this.state.modules[i].action}
            variant="outlined"
          >
              <option value=''></option>
        ...
        >
          <TextField
            ...
            value={this.state.modules[i].sensor}
            variant="outlined"
          >
              {
  ...
  save = async () => {
    ...
    if (name !== '') {
        ...
        this.setState({err:''})
        await api.updateConfigurationById(this.props.id, data).then(res => {
            window.alert('Конфигурация изменена успешно!')
            this.setState({
              name: '',
              containers: [],
              modules: [],
